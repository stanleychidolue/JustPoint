"""
Django settings for JustPoint project.
...
DEBUG = DEBUG = eval(os.environ.get("DEBUG"))
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "Home.context_processors.base_request",
            ],
        },
    },
]

WSGI_APPLICATION = "JustPoint.wsgi.application"
